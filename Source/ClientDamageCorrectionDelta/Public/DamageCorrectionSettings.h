...
UCLASS(Config = Game, DefaultConfig, meta = (DisplayName = "Client Damage Correction Delta"))
...
public:
	...
	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "Client Damage Correction Delta")
	...
	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "Client Damage Correction Delta", meta = (EditCondition = "ValidationMode == EDamageCorrectionValidationMode::ClientWithValidation"))
	...
	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "Client Damage Correction Delta", meta = (EditCondition = "ValidationMode == EDamageCorrectionValidationMode::ClientWithValidation && bValidateDistance", ClampMin = "1.0", ForceUnits = "cm"))
	...
	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "Client Damage Correction Delta", meta = (ClampMin = "0.0", ClampMax = "1.0", ForceUnits = "s"))
	float DamageIgnoreDelay = 0.05f;

	// Seconds an unmatched client bone report is kept before being discarded.
	UPROPERTY(Config, EditAnywhere, BlueprintReadOnly, Category = "Client Damage Correction Delta", meta = (ClampMin = "1.0", ForceUnits = "s"))
